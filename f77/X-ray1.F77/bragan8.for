c=============================================================
c This is an new-style BRAGAN with Double-Precision (Bragan8,d8)
c
c It can be used with Back Diffraction Programs because it
c takes QB=90 even if lambda/2d ~ 1.+OVER
c=============================================================
        Real*8 Function Bragan8 (wave,                          !input,  real
...
c iwarn=1 --  take QB = 0 and warn:                       |   |
  2       continue       !<-------------------------------+   |
          Bragan8 = 0.                                   !|   |
          Call Bragan_Warn8 (f8,ind,inmax)               !|   |
...
c  ==================================================================
        ...
        Subroutine      Bragan_Warn8 (f8,ind,inmax)
        Real*8          f8
